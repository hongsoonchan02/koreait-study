...
public class Ex08_Array {
	...
	public static void main(String[] args) {
		...
		// -------------------------------------------
		// Arrays.toString()
		//	- 반복문 없이 배열의 값들을 문자열 형대로 출력해주는 메서드
...
//		System.arraycopy(복사할 원본 배열, 복사를 시작할 인덱스, 저장할 배열, 저장을 시작할 위치, 복사할 요소의 수);
